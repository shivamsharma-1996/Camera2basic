    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Log.i("ooooooo", String.valueOf(displayRotation));
                Log.i("ooooooo", String.valueOf(mSensorOrientation));
                Log.i("123456", String.valueOf(mSensorOrientation));
    ...
    private void captureStillPicture() {
        try {
           ...
           /* Log.i("rotation", String.valueOf(rotation));
            Log.i("rotation", String.valueOf(mSensorOrientation));*/
